...
type OrdPromoCodes struct {
	...
	DiscountValue float64     `json:"discount_value" orm:"discount_value" description:"折扣值（百分比 0-100，立减为金额）"`                // 折扣值（百分比 0-100，立减为金额）
	MinAmount     float64     `json:"min_amount"     orm:"min_amount"     description:"最低订单金额"`                              // 最低订单金额
	MaxDiscount   float64     `json:"max_discount"   orm:"max_discount"   description:"最大折扣金额（0=不限）"`                        // 最大折扣金额（0=不限）
