...
type PlnPlans struct {
	...
	MonthlyPrice       float64     `json:"monthly_price"        orm:"monthly_price"        description:"月度价格（CNY）"`                         // 月度价格（CNY）
	YearlyPrice        float64     `json:"yearly_price"         orm:"yearly_price"         description:"年度价格（CNY，通常为月价×10）"`                // 年度价格（CNY，通常为月价×10）
