...
type TntTenantLevelConfigs struct {
	...
	CumulativeRechargeThreshold decimal.Decimal `json:"cumulative_recharge_threshold" orm:"cumulative_recharge_threshold" description:"累计充值阈值（USD），达到此值自动升级"` // 累计充值阈值（USD），达到此值自动升级
	...
	PriceMultiplier             decimal.Decimal `json:"price_multiplier"              orm:"price_multiplier"              description:"价格乘数（折扣，如 0.9=九折）"`    // 价格乘数（折扣，如 0.9=九折）
