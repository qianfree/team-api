...
type MdlTenantModels struct {
	...
	CustomCacheReadPrice     float64     `json:"custom_cache_read_price"     orm:"custom_cache_read_price"     description:"自定义缓存读取价格（$/1M token），NULL 表示使用基础定价"`                                                                                                                             // 自定义缓存读取价格（$/1M token），NULL 表示使用基础定价
	CustomCacheCreationPrice float64     `json:"custom_cache_creation_price" orm:"custom_cache_creation_price" description:"自定义缓存创建价格（$/1M token），NULL 表示使用基础定价"`                                                                                                                             // 自定义缓存创建价格（$/1M token），NULL 表示使用基础定价
