...
type ApiKeys struct {
	...
	TotalQuota           float64     `json:"total_quota"            orm:"total_quota"            description:"额度上限（NULL 表示不限制）"`                                                                                  // 额度上限（NULL 表示不限制）
	UsedQuota            float64     `json:"used_quota"             orm:"used_quota"             description:"已使用额度"`                                                                                             // 已使用额度
