...
var Registry = []SettingDef{
	...
	{Key: "turnstile_site_key", Type: SettingTypeString, Default: "", Category: "security",
		Label: "Turnstile Site Key", Sensitive: false},
	...
	{Key: "payment_min_topup", Type: SettingTypeInt, Default: "1", Category: "payment",
		Label: "最低充值金额", Validation: "min:1"},
	...
	{Key: "global_qps_limit", Type: SettingTypeInt, Default: "10000", Category: "performance",
		Label: "系统级 QPS 上限", Validation: "min:100,max:1000000"},
	{Key: "tenant_qps_limit", Type: SettingTypeInt, Default: "1000", Category: "performance",
		Label: "租户级 QPS 上限", Validation: "min:10,max:100000"},
	{Key: "user_qps_limit", Type: SettingTypeInt, Default: "100", Category: "performance",
		Label: "用户级 QPS 上限", Validation: "min:1,max:10000"},
	{Key: "key_qps_limit", Type: SettingTypeInt, Default: "60", Category: "performance",
		Label: "Key 级 QPS 上限", Validation: "min:1,max:10000"},
	{Key: "tenant_concurrency_limit", Type: SettingTypeInt, Default: "50", Category: "performance",
		Label: "租户级并发上限", Validation: "min:1,max:10000"},
	...
	{Key: "global_concurrency_limit", Type: SettingTypeInt, Default: "1000", Category: "performance",
		Label: "系统级并发上限", Validation: "min:10,max:100000"},
